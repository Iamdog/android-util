...
public class RxToast {
    ...
    @ColorInt
    private static final int ERROR_COLOR = Color.parseColor("#f04c62");

    @ColorInt
    private static final int INFO_COLOR = Color.parseColor("#3F51B5");

    @ColorInt
    private static final int SUCCESS_COLOR = Color.parseColor("#01D9AE");
    ...
    public static void init(Context context) {
        RxToast.context = context.getApplicationContext();
    }
